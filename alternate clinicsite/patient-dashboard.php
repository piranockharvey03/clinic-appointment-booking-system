            ...
            <main class="p-4 sm:px-6 lg:px-8">
                <div class="bg-blue-600 rounded-lg shadow-sm p-6 mb-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-2xl font-bold text-white">Welcome back, <?php echo h($fullName); ?>!</h2>
                            <p class="mt-1 text-blue-100">Here's what's happening with your health today.</p>
                        </div>
                        <a href="patient-book.php" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-blue-600 bg-white hover:bg-blue-50">
                            Book Appointment
                ...
                <div class="bg-white shadow rounded-lg overflow-hidden mb-6">
                    ...
                    <div class="px-4 py-4 sm:px-6 bg-gray-50 text-right">
                        <a href="patient-appointments.php" class="text-sm font-medium text-blue-600 hover:text-blue-500">View all appointments</a>
                    </div>
                </div>
