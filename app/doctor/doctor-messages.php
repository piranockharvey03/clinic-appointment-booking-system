                ...
                <div class="flex-1 overflow-y-auto">
                    <nav class="p-4">
                        <div class="space-y-1">
                            ...
                            <a href="doctor-messages.php" class="flex items-center px-4 py-2 text-sm font-medium rounded-md bg-blue-900 text-white">
        ...
        <div class="main-content flex-1 overflow-auto w-full flex flex-col">
            ...
            <header class="bg-white shadow-sm">
                <div class="px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
                    ...
                    <h1 class="text-lg font-semibold text-gray-900">Patient Messages</h1>
